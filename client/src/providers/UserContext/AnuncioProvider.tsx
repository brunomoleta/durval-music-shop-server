...
const AnuncioProvider = (props: { children: ReactNode }) => {
    ...
    const [ isDeleteAnuncioModalOpen, setIsDeleteAnuncioModalOpen ] = useState<boolean>(false);
    ...
    return (
        <AnuncioContext.Provider value={values}>{props.children}</AnuncioContext.Provider>
        );
    };
